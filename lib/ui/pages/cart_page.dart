...
class _CartPageState extends State<CartPage> {
  ...
  void getData() async {
    ...
    apartmentController.text = userModel.apartment;
          ...
          body: isLoading
              ...
              : SingleChildScrollView(
                  child: Column(
                              ...
                              SizedBox(
                                  ...
                                  child: Row(
                                      ...
                                      children: [
                                        GestureDetector(
                                            onTap: () =>
                                                setState(() => isSelf = false),
                                            child: Text("Доставка на дом",
                                                style: TextStyle(
                                                    fontWeight: FontWeight.w400,
                                                    fontSize: 16,
                                                    color: isSelf
                      ...
                      const Padding(
                          padding:
                              EdgeInsets.only(top: 31, left: 29, bottom: 4),
                          child: Text("Оплата",
                              style: TextStyle(
                              ...
                              onTap: () {
                                if (total > 0) {
                                  ...
                                  FirebaseDatabase.instance
                                      ...
                                      .update({
                                    "adress":
                                        '${streetController.text} ${apartmentController.text} ${entranceController.text} ${floorController.text}',
