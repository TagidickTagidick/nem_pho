          ...
          if (isLoading)
            Padding(
                padding: const EdgeInsets.only(
                    top: 45, left: 36, right: 24, bottom: 30),
                child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Text(widget.product.text,
                              style: const TextStyle(
                      ...
                      Padding(
                          padding: const EdgeInsets.only(left: 52),
                          child: Text(widget.product.compound,
                              style: const TextStyle(
                                  fontWeight: FontWeight.w400,
                                  fontSize: 9,
                                  color: Color(0xff000000)))),
