        ...
        slivers: [
          ...
          SliverPadding(
              ...
              sliver: StreamBuilder(
                stream: FirebaseDatabase.instance.ref("menu/${widget.menuItem}").onValue,
                  ...
                  return SliverList(
                    delegate: SliverChildBuilderDelegate(
                        ...
                        return GestureDetector(
                          onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => ProductPage(product: menu[index]))),
                          child: Row(
                              children: [
                                Hero(
